...
class JSONStorage:
    ...
    def load_generic(self, model_class):
    ...
    def load_subjects(self):
        return self.load_generic(Subject)

    def save_subjects(self, subjects):
        return self.save_generic(subjects)
    ...
    def load_grades(self):
        return self.load_generic(Grade)

    def save_grades(self, grades):
        return self.save_generic(grades)
